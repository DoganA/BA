/**
 * Zeichnet die Verbrauchsdaten auf einen Graphen.
 * @param von -> Anfangsdatum, für den beginn des Zeitraumes bei dem die Verbrauchsdaten dargestellt werden sollen.
 * 		  bis -> Enddatum, für den ende des Zeitraumes bei dem die Verbrauchsdaten dargestellt werden sollen.
 */
function InitHighChart(von, bis) {
  ...
  var options = {
    ...
    navigation: {
      buttonOptions: {   // Modul zum Exportieren der Visuallisierung, als Bild bzw. PD
        enabled: true
      }
    },
